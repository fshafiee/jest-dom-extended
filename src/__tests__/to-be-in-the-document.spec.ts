...
test('.toBeInTheDocument', () => {
  ...
  const customElement = document.querySelector('[data-testid="custom-element"]')
  const customElementChild = customElement?.shadowRoot?.querySelector(
    '[data-testid="custom-element-child"]',
  )
