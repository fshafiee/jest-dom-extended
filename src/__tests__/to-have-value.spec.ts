...
describe('.toHaveValue', () => {
  test('handles value of text input', () => {
    ...
    const emptyInput = queryByTestId('without') as HTMLInputElement
    emptyInput.value = 'bar'
  ...
  test('handles value of number input', () => {
    ...
    const emptyInput = queryByTestId('without') as HTMLInputElement
    emptyInput.value = 10 as unknown as string
  ...
  test('handles value of select element', () => {
    ...
    queryByTestId('single')?.children[0]?.setAttribute(
      'selected',
